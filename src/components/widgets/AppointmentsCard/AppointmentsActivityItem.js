        ...
        <Row>
          ...
          <Col className="activityItem__info-cont" lg={7} md={7} sm={7} xs={7}>
            ...
            <div className="activityItem__info">
              ...
              <div className={"activityItem__description" + ((appointment.description) ? ' invisible' : '' )}><small>{(appointment.description) ? appointment.description : <i className="text-muted">no description provided</i> }</small></div>
